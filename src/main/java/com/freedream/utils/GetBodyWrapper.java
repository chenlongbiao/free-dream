package com.freedream.utils;

import com.freedream.Interceptor.testInteper;
import com.freedream.utils.Encodes;
 ...
 */
public class GetBodyWrapper extends HttpServletRequestWrapper {
    ...
    public GetBodyWrapper(HttpServletRequest request) throws IOException {
        super(request);
